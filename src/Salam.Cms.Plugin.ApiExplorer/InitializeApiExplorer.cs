...
using Salam.Cms.Plugin.ApiExplorer.Infrastructure;
...
namespace Salam.Cms.Plugin.ApiExplorer
{
    public static class ApiExplorerStartupExtensions
    {
        ...
        public static IServiceCollection AddApiExplorer(this IServiceCollection services, ApiExplorerOptions options)
        {
            ...
            services.Configure<ProtectedModuleOptions>(o => o.Items.Add(new ModuleDetails { Name = "Salam.Cms.Plugin.ApiExplorer" }));
        ...
        public static IApplicationBuilder UseApiExplorer(this IApplicationBuilder app, Action<SwaggerUIOptions> setupUI) => app.UseApiExplorer(true, setupUI);

        public static IApplicationBuilder UseApiExplorer(this IApplicationBuilder app, bool mapEndpoints = true, Action<SwaggerUIOptions>? setupUI = null, params SwaggerEndpointModel[] swaggerEndpoints)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                //This style change hides the dropdown if there is more than one endpoint
                ...
                c.OAuthAppName("Salam.Cms.Plugin.ApiExplorer");
