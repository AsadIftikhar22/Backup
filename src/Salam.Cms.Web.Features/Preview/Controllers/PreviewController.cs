namespace Salam.Cms.Web.Features.Preview.Controllers;
...
using Salam.Cms.Web.Features.Preview.ViewModels;
using System.Linq;
...
public class PreviewController : ActionControllerBase, IRenderTemplate<BlockData> //, IModifyLayout // TODO: Implement layout modification
{
    ...
    public IActionResult Index(IContent currentContent)
    {
        ...
        var model = new PreviewModel(startPage, contentAreaItem);
    ...
    // TODO: Implement layout modification
