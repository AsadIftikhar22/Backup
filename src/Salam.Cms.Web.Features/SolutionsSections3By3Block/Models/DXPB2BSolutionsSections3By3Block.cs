...
[ContentType(
    DisplayName = "DXP B2B Solutions Sections Block 3 By 3",
    GUID = "ddffb67d-7a47-4911-b9c3-27a811521bae",
    Description = "Displays an DXP B2B Business Solutions Block and allows the content editor to add content to the Solutions Sections Block 3 By 3.",
    GroupName = SystemTabNames.Content)]
[ContentTypeIcon(FontAwesome5Solid.List)]
public class DXPB2BSolutionsSections3By3Block : SiteContentBlock
{
    [Display(
        Name = "Heading",
        GroupName = SystemTabNames.Content,
    ...
    [Display(
    Name = "Icon 5",
    Description = "The icon to be displayed on card 5.",
    GroupName = GroupNames.SolutionsBlockIcons,
    Order = 10)]
    [UIHint(SalamUIHint.IconLibrary)]
    public virtual ContentReference? Icon5 { get; set; }

    [Display(
    Name = "Icon 6",
    Description = "The icon to be displayed on card 6.",
    GroupName = GroupNames.SolutionsBlockIcons,
    Order = 10)]
    [UIHint(SalamUIHint.IconLibrary)]
    public virtual ContentReference? Icon6 { get; set; }
}
