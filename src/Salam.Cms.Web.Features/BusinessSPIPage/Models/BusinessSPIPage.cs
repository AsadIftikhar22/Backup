...
[ContentType(
    DisplayName = "Business SPI Pages",
    Description = " A Business SPI Page, page is a page that is designed to be the first point of contact for B2b Supports." +
    " It typically contains only content without Header and Footer",
    GUID = "cff28cea-b441-4f4e-b49d-ab8a2a26b80c",
    GroupName = GroupNames.Content)]
[ContentTypeIcon(FontAwesome5Solid.MapSigns)]
public class BusinessSPIPage : B2BSitePageData, INavigationItem, IPageNavigatorEnabled
{
    [Display(
